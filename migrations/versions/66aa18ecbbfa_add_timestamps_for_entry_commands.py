...
def upgrade() -> None:
    ...
    op.add_column('entries', sa.Column('deleted', sa.TIMESTAMP(), nullable=True, server_default=None))
    op.add_column('entries', sa.Column('favorited', sa.TIMESTAMP(), nullable=True, server_default=None))
    op.add_column('entries', sa.Column('pinned', sa.TIMESTAMP(), nullable=True, server_default=None))
